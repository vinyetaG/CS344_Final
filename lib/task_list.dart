                ...
                setState(() {
                  switch (sortOption) {
                    ...
                    case ('name'):
                      ...
                      break;
                    case ('date'):
                      //TODO: widget.taskModel.sortByDue();
                      break;
                  }
                });
              },
        ...
        Expanded(
          child: ListView.separated(
            ...
            itemBuilder: (BuildContext context, int index) {
              //TODO: fix bug where it attempts to access out of bounds tasks after enough removals
              TaskItem currTask = widget.taskModel.getTask(index);
              //Show first 50 characters of description on list tile
              String? descriptionPrev = currTask.description;
              if (descriptionPrev != null && descriptionPrev.length > 50) {
                descriptionPrev = "${descriptionPrev.substring(0, 50)}...";
              }
